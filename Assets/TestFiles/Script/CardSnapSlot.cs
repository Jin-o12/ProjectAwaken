...
public class CardSnapSlot : MonoBehaviour
{
    ...
    void GenerateSlots()
    {
        ...
        for (int i = 0; i < numberOfReadySlots; i++)
        {
            ...
            newSlot.anchoredPosition = new Vector2(spacing * (i + 1) - (width / 2), 0);
            slots.Add(newSlot);
