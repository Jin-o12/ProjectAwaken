...
public class EntityStatus
{
    ...
    public EntityCode GetEntityCode() { return code; }
...
public static class EntityDataLoader
{
    ...
    private static Dictionary<EntityCode, EntityStatus> entityDataMap;
    ...
    public static void LoadEntityStatus()
    {
        ...
        if (jsonFile == null)
        {
            entityDataMap = new Dictionary<EntityCode, EntityStatus>();
            return;
        }
    ...
    /* 플레이어 객체 데이터 호출 */
    public static PlayerStatus GetPlayerStatusById(EntityCode codeId)
    {
    ...
    /* 적 객체 데이터 호출 */
    public static EnemyStatus GetEnemyStatusById(EntityCode codeId)
    {
        if (entityDataMap.TryGetValue(codeId, out EntityStatus data))
        {
